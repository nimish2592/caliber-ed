...
export default function LoginPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    router.push(data.platform ? "/admin" : "/");
    router.refresh();
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Sign in to your campus workspace</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl space-y-4">
          ...
          <p className="text-center text-xs text-slate-500">
            Use a Gmail account your admin has added by name and email.
          </p>
